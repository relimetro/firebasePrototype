...
func (x *UserRequest) GetSessionToken() string {
	if x != nil {
...
func (x *SessionToken) GetTemp() string {
	if x != nil {
		return x.Temp
	}
	return ""
...
type UserDetails struct {
	...
	Detauls string `protobuf:"bytes,1,opt,name=detauls,proto3" json:"detauls,omitempty"`
}
...
func (x *UserDetails) GetDetauls() string {
	if x != nil {
		return x.Detauls
	}
	return ""
...
func (x *RiskScore) GetScore() int64 {
	if x != nil {
		return x.Score
	}
	return 0
...
var file_proto_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x0c, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x54, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x12, 0x0a, 0x04, 0x74, 0x65, 0x6d, 0x70, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x74,
	...
	0x75, 0x6c, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x75,
	...
	0x6b, 0x53, 0x63, 0x6f, 0x72, 0x65, 0x22, 0x00, 0x42, 0x17, 0x5a, 0x15, 0x65, 0x78, 0x61, 0x6d,
	0x70, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x5f, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c,
